...
const Button = ({ className, children, disabled, iconColor, iconLeft, iconRight, iconSize, id, onClick, size, status, type = 'button', ...props }) => {
    ...
    return (react_1.default.createElement(ButtonSC, Object.assign({ as: sc && sc.button, className: className, disabled: disabled, id: id, onClick: onClick, size: size, status: status, type: type }, props),
        iconLeft && react_1.default.createElement(Icon_1.default, { color: iconColor, size: iconSize, value: iconLeft }),
