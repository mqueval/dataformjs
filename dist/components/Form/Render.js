...
const Form = props => {
    const { bodyClassName, children, className, error, 
    // errorValues,
    footerClassName, formValues, handleSubmit, invalid, name, pristine, submitLabel = 'form/submit', submitting, valid, } = props;
