...
var DataArrayRender = function (_a) {
    var addButtonIcon = _a.addButtonIcon, addButtonLabel = _a.addButtonLabel, addButtonPosition = _a.addButtonPosition, datas = _a.datas, _b = _a.defaultValue, defaultValue = _b === void 0 ? '' : _b, fields = _a.fields, formName = _a.formName, meta = _a.meta;
            ...
            fields.map(function (field) {
                if (datas && datas.length > 0) {
                    if (datas.length > 1 || datas[0].datas) {
                        return (react_1.default.createElement(redux_form_1.FormSection, { key: field + "_" + object_hash_1.default(datas), name: field }, datas.map(function (value) { return (react_1.default.createElement(index_1.default, __assign({ key: field + "_" + object_hash_1.default(value) }, value, { formName: formName }))); })));
                    }
                    return (react_1.default.createElement(index_1.default, __assign({ key: field }, datas[0], { formName: formName, name: field })));
                }
