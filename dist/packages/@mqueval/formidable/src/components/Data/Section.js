...
var DataSection = function (_a) {
    var datas = _a.datas, name = _a.name, props = __rest(_a, ["datas", "name"]);
    return (react_1.default.createElement(SectionSC, __assign({}, props),
        react_1.default.createElement(redux_form_1.FormSection, { name: name }, datas &&
            datas.length > 0 &&
            datas.map(function (data) { return react_1.default.createElement(index_1.default, __assign({ key: object_hash_1.default(data) }, data)); }))));
};
